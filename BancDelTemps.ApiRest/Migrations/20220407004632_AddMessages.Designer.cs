...
namespace BancDelTemps.ApiRest.Migrations
{
    ...
    [Migration("20220407004632_AddMessages")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BancDelTemps.ApiRest.Models.Message", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<DateTime?>("DateMarkedToRevision")
                        .HasColumnType("datetime(6)");
                    ...
                    b.Property<DateTime?>("DateToAndFromHidden")
                        .HasColumnType("datetime(6)");

                    b.Property<long>("FromId")
                        .HasColumnType("bigint");

                    b.Property<bool>("IsHiddenFrom")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("IsHiddenTo")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("BancDelTemps.ApiRest.Models.Message", b =>
                {
                    b.HasOne("BancDelTemps.ApiRest.Models.User", "From")
                    ...
                    b.HasOne("BancDelTemps.ApiRest.Models.User", "Revisor")
                        .WithMany("MessageRevised")
                        .HasForeignKey("RevisorId");

                    b.HasOne("BancDelTemps.ApiRest.Models.User", "To")
                        .WithMany("MessageTo")
                        .HasForeignKey("ToId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
